...
class ProductPageLocators:
    ...
    LIKE_BUTTON = (By.CSS_SELECTOR, 'li:nth-child(1) [id^="like-btn"]')
    LIKE_COUNTER = (By.CSS_SELECTOR, 'li:nth-child(1) [id^="like-btn"] span')
    DISLIKE_BUTTON = (By.CSS_SELECTOR, 'li:nth-child(1) [id^="dislike-btn"]')
    DISLIKE_COUNTER = (By.CSS_SELECTOR, 'li:nth-child(1) [id^="dislike-btn"] span')
