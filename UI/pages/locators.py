...
class EditProfilePageLocators:
    ...
    EMPTY_MESSAGE = (By.XPATH, "//*[contains(text(), 'name is required')]")
    NONLATIN_MESSAGE = (By.XPATH, "//*[contains(text(), 'Invalid name format. Use extended Latin letters, spaces, and specified symbols')]")
